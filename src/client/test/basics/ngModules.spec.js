...
describe('Basics - ngModules:', function() {
    ...
    var tFeature1 = angular.module('test.feature1', ['test.core', 'test.block1']);
    var tFeature2 = angular.module('test.feature2', ['test.core', 'test.block2']);

    var tCore = angular.module('test.core', ['test.block1']);

    // Blocks are mutually dependent. Bad design but we want to see what happens
    var tBlock1 = angular.module('test.block1', ['test.block1']);
    var tBlock2 = angular.module('test.block2', ['test.block2']);
    ...
    describe('when getting providers', function() {
        ...
        beforeEach(module('test.app',
            // capture a provider to play with during module setup
        ...
        it('the $controllerProvider becomes available AFTER inject', function () {
            ...
            inject();
            expect($controllerProvider).to.exist;
        });
    });
    //////////
